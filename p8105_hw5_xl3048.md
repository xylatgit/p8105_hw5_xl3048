...
<img src="p8105_hw5_xl3048_files/figure-gfm/p3_plot-1.png" width="90%" />
...
``` r
  ...
  # geom_text(aes(label = round(avg_estimate_mu,2)),hjust=2,vjust=-1)+
  # labs(title = "true mu v.s average estimated mu")
...
``` r
ggplot(df1, aes(x = true_mu, y = avg_estimate_mu, fill = true_mu))+
  geom_point(size = 5, col="tomato2")+
  geom_point(data=df2, color = "blue",size =5)+
  labs(title = "true mu v.s average estimated mu")
```

<img src="p8105_hw5_xl3048_files/figure-gfm/unnamed-chunk-8-1.png" width="90%" />
